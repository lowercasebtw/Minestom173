...
public class HellFireFeature implements WorldGenerator {
    @Override
    public boolean populate(Level level, Random random, int i, int i2, int i3) {
        for (int var6 = 0; var6 < 64; var6++) {
            ...
            if (level.m_64558657(var7, var8, var9) && level.getTile(var7, var8 - 1, var9) == Tile.NETHERRACK.id) {
                level.setTile(var7, var8, var9, Tile.FIRE.id);
            }
        }
