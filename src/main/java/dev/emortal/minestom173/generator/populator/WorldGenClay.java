...
public class WorldGenClay implements WorldGenerator {
    ...
    public boolean populate(final WorldContext worldContext, int centerX, int centerY, int centerZ) {
        if (worldContext.getBlock(centerX, centerY, centerZ) != Block.WATER) {
            return false;
        } else {
                    ...
                    for (int l2 = k1; l2 <= l1; ++l2) {
                        for (int i3 = i2; i3 <= j2; ++i3) {
                            ...
                            if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
                                Block j3 = worldContext.getBlock(k2, l2, i3);
