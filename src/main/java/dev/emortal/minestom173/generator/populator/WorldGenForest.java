...
public class WorldGenForest implements WorldGenerator {
    private final int minHeight;
    private final int maxHeight;

    public WorldGenForest(int minHeight, int maxHeight) {
            ...
            if (!flag) {
                ...
                if ((type == Block.GRASS_BLOCK || type == Block.DIRT) && centerY < 128 - l - 1) {
                        ...
                        for (l1 = centerX - k1; l1 <= centerX + k1; ++l1) {
                            ...
                            for (int k2 = centerZ - k1; k2 <= centerZ + k1; ++k2) {
                                ...
                                if ((Math.abs(j2) != k1 || Math.abs(l2) != k1 || random.nextInt(2) != 0 && j1 != 0) && !LegacyUtil.Block_o(worldContext.getBlock(l1, i2, k2))) {
                                    worldContext.setBlock(l1, i2, k2, Block.BIRCH_LEAVES);
                                }
                            }
                        }
                    }
                    ...
                    for (i2 = 0; i2 < l; ++i2) {
                        ...
                        if (type.isAir() || BlockConstants.isLeaves(type)) {
                            worldContext.setBlock(centerX, centerY + i2, centerZ, Block.BIRCH_LOG);
                        }
                    }
